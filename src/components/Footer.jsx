...
export function FooterContent() {
  return (
    <div className="w-full flex flex-col sm:flex-row items-center justify-center sm:justify-between gap-3 px-4 sm:px-6 md:px-16 text-[13px] text-[#9A9AA5] text-center sm:text-left">
