...
export default function CaseStudyCard({ cs }) {
  ...
  return (
    <div className="rounded-[28px] overflow-hidden shadow-[0_2px_24px_rgba(20,20,26,0.06)] border border-black/[0.04]">
      <div className={`flex flex-col ${cs.reverse ? "md:flex-row-reverse" : "md:flex-row"}`}>
        <div className="flex-1 bg-white p-6 sm:p-8 md:p-10 flex flex-col justify-center">
          ...
          <p className="text-[13px] sm:text-[14px] leading-relaxed text-[#6C6C76] mb-6 max-w-sm">{cs.body}</p>
        ...
        <div className="flex-1 flex items-center justify-center p-6 sm:p-8 md:p-10" style={{ background: cs.panelBg }}>
          <Mock />
        </div>
      </div>
    </div>
